...
import { FaBox, FaSearch, FaCheckCircle, FaClock } from 'react-icons/fa';
...
const Dashboard = () => {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      pending: { color: 'bg-yellow-100 text-yellow-800', icon: <FaClock className="w-4 h-4" /> },
      matched: { color: 'bg-blue-100 text-blue-800', icon: <FaCheckCircle className="w-4 h-4" /> },
      claimed: { color: 'bg-green-100 text-green-800', icon: <FaCheckCircle className="w-4 h-4" /> },
      unclaimed: { color: 'bg-gray-100 text-gray-800', icon: <FaBox className="w-4 h-4" /> },
    };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <p className={`text-sm ${stat.trend === 'up' ? 'text-green-600' : stat.trend === 'down' ? 'text-red-600' : 'text-gray-500'}`}>
                  {stat.change}
                </p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Report Lost Item</p>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Report Found Item</p>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">3 unread notifications</p>
                </div>
              </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                  ...
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <span className="ml-2 text-sm font-medium text-gray-700">{item.confidence}%</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <Link
        ...
        {recentItems.filter(item => activeTab === 'all' || item.type === activeTab).length === 0 && (
